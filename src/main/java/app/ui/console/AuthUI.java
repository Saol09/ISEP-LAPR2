...
public class AuthUI implements Runnable{
    ...
    private List<MenuItem> getMenuItemForRoles()
    {
        ...
        rolesUI.add(new MenuItem(Constants.ROLE_CLINICAL_CHEMISTRY_TEC, new ClinicalChemistryTechnologistUI()));
        rolesUI.add(new MenuItem(Constants.ROLE_LAB_COORDINATOR, new LaboratoryCoordinatorUI()));
